...
df_mapping_region = pd.read_csv('DATA/correspondance region et police_force.csv', sep =';')
...
df.to_csv('DATA/CLEAN/Append_Time_cat_Road_Accident_Data.csv', index=False)
...
df.to_csv('DATA/CLEAN/Output_Road_Accident_Data.csv', index=False) 
...
df_sample.to_csv('DATA/CLEAN/sample_balanced_9000.csv', index=False)
